...
<div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <h1 class="text-2xl font-bold text-gray-800">Project Section</h1>
        ...
        <table class="w-full text-left text-sm">
            <thead class="bg-gray-50 text-gray-600 uppercase font-semibold">
                <tr>
                    ...
                    <th class="px-6 py-4">url_target</th>
            ...
            <tbody class="divide-y divide-gray-100 text-gray-700">
                <tr>
                    ...
                    <td class="px-6 py-4 text-center">
                        <button
                            class="text-gray-400 hover:text-indigo-600 transition p-2 hover:bg-indigo-50 rounded-lg">
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form class="p-6 space-y-4">
            ...
            <div class="flex justify-end gap-3 pt-4">
                ...
                <button type="submit"
                    class="px-6 py-2 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700">Save
                    User</button>
            </div>
        </form>
    </div>
